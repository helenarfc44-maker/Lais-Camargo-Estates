...
export function Header({ onNav, currentPage = "home" }: HeaderProps) {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isTransparent ? 'bg-transparent border-b border-transparent shadow-none' : 'bg-verde/95 backdrop-blur-md border-b border-white/10 shadow-sm'}`}>
